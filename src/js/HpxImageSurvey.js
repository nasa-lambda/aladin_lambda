...
HpxImageSurvey = (function() {
    ...
    HpxImageSurvey.DEFAULT_SURVEY_ID = "P/PLANCK/R2/LFI/color";
    
    HpxImageSurvey.SURVEYS_OBJECTS = {};
    HpxImageSurvey.BACKGROUNDS = [
     /*{
        "id": "P/2MASS/color",
    ...
    {
        "id": "P/PLANCK/R2/CMB",
        "url": "http://alasky.u-strasbg.fr/PLANCK/R2/COM_CMB_IQU-smica-field-Int_2048_R2.00/",
        "name": "Planck CMB",
        "maxOrder": 3,
        "frame": "galactic",
        "format": "png fits"
  ...
  HpxImageSurvey.SURVEYS = HpxImageSurvey.BACKGROUNDS.concat(HpxImageSurvey.FOOTPRINTS);
    ...
    HpxImageSurvey.getAvailableFootprints = function() {
        return HpxImageSurvey.FOOTPRINTS;
    };
    
    HpxImageSurvey.getAvailableBackgrounds = function() {
        return HpxImageSurvey.BACKGROUNDS;
    };
...
*/
    ...
    HpxImageSurvey.prototype.draw = function(ctx, view, subdivide) {
        ...
        if (subdivide) {
            if (view.curNorder>=3) {
                this.drawHighres(ctx, cornersXYViewMapHighres, view.curNorder, view);

                this.drawAllsky(ctx, cornersXYViewMapAllsky, view.fov, view.curNorder, view);
            }
...
console.log('********************************************************************');
        ...
        for (var k=0; k<cornersXYViewMap.length; k++) {
            hpxKeys.push(new HpxKey(norder, cornersXYViewMap[k].ipix, this, 512, 512));
        }
